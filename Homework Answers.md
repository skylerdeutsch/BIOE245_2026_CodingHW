...
**Q1. Is AUC used in this training script? If so, is it applied directly for binary classification, or are there adaptations for multi-class classification?**

A:

**Q2. What curve does "AUC" refer to? Plot this curve for the saved model evaluated on the test set.**

A:

**Q3. From the test set, find examples for 5 classes of your choice:**
